	...
	<div class="container">
		<form method="get"
			...
			<div class="search-bar">
				...
				<button class="mainBtn">검색</button>
			</div>
		</form>
		...
		<div class="categories-container">
			<div class="categories">
				<a
					...
					ㆍ 영천 ㆍ 경주 ㆍ 경산</a> <a
					href="${contextPath}/accommodation/searchAddress?keyword=대구ㆍ울릉ㆍ청도ㆍ독도">대구 ㆍ 울릉
					ㆍ 청도 ㆍ 독도</a>
			</div>
		</div>
			...
			<c:forEach items="${accommodationList}" var="accommodation">
				<div class="accommodation-card">
					<div class="image-container">
						...
						</a> <span class="heart-icon ${accommodation.liked ? 'liked' : ''}"
